    ...
    <section className="memory">
      ...
      <div className="mem-row">
        <div className="mem-cell">
          <div className="mem-n">{message_count}<span className="mem-of">/{MAX_MESSAGES}</span></div>
      ...
      <div className={`summary-box ${summary ? '' : 'empty'} ${flash ? 'summary-flash' : ''}`}>
        {summary || 'Nothing summarized yet. Past 12 messages, older turns get folded in here.'}
      </div>
    </section>
  )
}
